...
config c =new config();
   ...
   String Query= "Update register set Password='"+finalpassword1+"' where EmailId='"+email+"' and Password='"+finalpassword+"'";
   //out.println(Query);
  ...
  <body>
                    ...
                    <span style=" font-size: 30px; font-style:  italic; color: navy;"> Password has been changed successfully ..!!</span>
